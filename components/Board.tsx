      ...
      <Droppable droppableId="board" direction="horizontal" type="column">
        {(provided) => (
          <div
            ...
            className="grid grid-cols-1 md:grid-cols-3 gap-3 max-w-7xl mx-auto mt-4"
          >
